# WatchMatch (Wama) Development Report

Welcome to the documentation of WatchMatch (Wama)!

This Software Development Report, tailored for LEIC-ES-2025-26, provides comprehensive details about WatchMatch, starting from an high-level vision and going into low-level implementation decisions.
...
* Pedro Fernandes up202304500@up.pt
* Tomás Silva up202307796@up.pt
* Lara Henriques up202405711@up.pt
* Maria Santos up202406584@up.pt
* Pedro Marques up202107525@up.pt
...
-->
To transform the often-frustrating process of choosing a movie into a seamless, engaging, and collaborative experience by making discovery fast, social, and personalized.
...
-->
* As a user I want an app that helps me choose a movie/series to watch that I may enjoy based on my personal likes.
* As a user I want an app that helps choose a movie/series to watch with a group of friends based on our preferences.
* As a user, I want to be able to create an account so that I can save and review movies under my account.
* As a user, I want to organize movies into shelves so that I can manage my movie collection.
